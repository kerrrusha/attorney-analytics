...
export default function CrudTable({initialData_, postDataHandler, disabled=false}: CrudTableProps) {
    ...
    return <div className="flex flex-row items-center">
        <div className="flex-1">
            <table id="crud-table" className="m-0 table table-bordered bg-white">
                <tbody>
